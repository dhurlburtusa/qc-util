...
function __coerseEol(to) {
  /* eslint require-jsdoc: "off" */
  return function (text) {
    if (typeof text == 'string') {
      text = text.replace(NEWLINE_RE, to);
    }
    return text;
  };
}
...
/**
 * Normalizes line endings to CR.
 *
 * @function module:String.cr
 *
 * @param {string} input - The input to be normalized.
 *
 * @returns {string} The normalized input or the non-string input.
 */
const cr = __coerseEol('\r');


/**
 * Normalizes line endings to CRLF.
 *
 * @function module:String.crlf
 *
 * @param {string} input - The input to be normalized.
 *
 * @returns {string} The normalized input or the non-string input.
 */
const crlf = __coerseEol('\r\n');


/**
 * Normalizes line endings to LF.
 *
 * @function module:String.lf
 *
 * @param {string} input - The input to be normalized.
 *
 * @returns {string} The normalized input or the non-string input.
 */
const lf = __coerseEol('\n');
