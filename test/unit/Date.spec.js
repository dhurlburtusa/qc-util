...
function _addAndExpect(inputDateInfo, inputExpectedTime, inputExpectedTimezoneOffset, unit, increment, outputExpectedTimeInfo, outputExpectedTime, outputExpectedTimezoneOffset) {
  var date, expectedDay, expectedHours, expectedMonth, expectedYear;

  expectedYear = outputExpectedTimeInfo[0];
  expectedMonth = outputExpectedTimeInfo[1];
  expectedDay = outputExpectedTimeInfo[2] || 1;
  expectedHours = outputExpectedTimeInfo[3] || 0;

  date = createDateFromArray(inputDateInfo, inputExpectedTime, inputExpectedTimezoneOffset);
  date = Dte.add(date, unit, increment);
  expect(date.getTime()).toBe(outputExpectedTime);
  expect(date.getTimezoneOffset()).toBe(outputExpectedTimezoneOffset);
...
function _diffAndExpect(date1, date2, unit, expectedDiff) {
  expect(Dte.diff(date1, date1, unit)).toBe(0);
  expect(Dte.diff(date2, date2, unit)).toBe(0);
  expect(Dte.diff(date1, date2, unit)).toBe(expectedDiff);
  expect(Dte.diff(date2, date1, unit)).toBe(-expectedDiff);
}
...
describe('QC.Dte', function () {
  ...
  describe('.add', function () {
    ...
    it('should add/subtract years that cause a DST change while maintaining the same non-year date parts', function () {
      ...
      if (guessedTz.name == 'America/Los_Angeles') {
        ...
        // STD to DST
        _addAndExpect([2014, 2, 8, 14], 1394316000000, 480, Dte.YEAR, 1, [2015, 2, 8, 14], 1425848400000, 420);

        // DST to STD
        _addAndExpect([2014, 2, 12, 14], 1394658000000, 420, Dte.YEAR, 2, [2016, 2, 12, 14], 1457820000000, 480);

        // NOTE: DST Ends on Nov 2nd at 02:00 in 2014

        // DST to STD
        _addAndExpect([2014, 10, 1, 14], 1414875600000, 420, Dte.YEAR, 1, [2015, 10, 1, 14], 1446415200000, 480);

        // STD to DST
        _addAndExpect([2014, 10, 2, 14], 1414965600000, 480, Dte.YEAR, -3, [2011, 10, 2, 14], 1320267600000, 420);

        // NOTE: DST Starts on March 8th at 02:00 in 2015

        // DST to STD
        _addAndExpect([2015, 2, 8, 14], 1425848400000, 420, Dte.YEAR, -1, [2014, 2, 8, 14], 1394316000000, 480);

        // NOTE: DST Ends on Nov 1st at 02:00 in 2015

        // STD to DST
        _addAndExpect([2015, 10, 1, 14], 1446415200000, 480, Dte.YEAR, -1, [2014, 10, 1, 14], 1414875600000, 420);

        // NOTE: DST Starts on March 13th at 02:00 in 2016

        // STD to DST
        _addAndExpect([2016, 2, 12, 14], 1457820000000, 480, Dte.YEAR, 1, [2017, 2, 12, 14], 1489352400000, 420);

        // NOTE: DST Ends on Nov 6th at 02:00 in 2016

        // STD to DST
        _addAndExpect([2016, 10, 6, 14], 1478469600000, 480, Dte.YEAR, -6, [2010, 10, 6, 14], 1289077200000, 420);

        // NOTE: DST Starts on March 12th at 02:00 in 2017

        // DST to STD
        _addAndExpect([2017, 2, 12, 14], 1489352400000, 420, Dte.YEAR, -1, [2016, 2, 12, 14], 1457820000000, 480);
      }
      else if (guessedTz.name == 'America/Denver') {
        // NOTE: DST Starts on March 9th at 02:00 in 2014

        // STD to DST
        _addAndExpect([2014, 2, 8, 14], 1394312400000, 420, Dte.YEAR, 1, [2015, 2, 8, 14], 1425844800000, 360);

        // DST to STD
        _addAndExpect([2014, 2, 12, 14], 1394654400000, 360, Dte.YEAR, 2, [2016, 2, 12, 14], 1457816400000, 420);

        // NOTE: DST Ends on Nov 2nd at 02:00 in 2014

        // DST to STD
        _addAndExpect([2014, 10, 1, 14], 1414872000000, 360, Dte.YEAR, 1, [2015, 10, 1, 14], 1446411600000, 420);

        // STD to DST
        _addAndExpect([2014, 10, 2, 14], 1414962000000, 420, Dte.YEAR, -3, [2011, 10, 2, 14], 1320264000000, 360);

        // NOTE: DST Starts on March 8th at 02:00 in 2015

        // DST to STD
        _addAndExpect([2015, 2, 8, 14], 1425844800000, 360, Dte.YEAR, -1, [2014, 2, 8, 14], 1394312400000, 420);

        // NOTE: DST Ends on Nov 1st at 02:00 in 2015

        // STD to DST
        _addAndExpect([2015, 10, 1, 14], 1446411600000, 420, Dte.YEAR, -1, [2014, 10, 1, 14], 1414872000000, 360);

        // NOTE: DST Starts on March 13th at 02:00 in 2016

        // STD to DST
        _addAndExpect([2016, 2, 12, 14], 1457816400000, 420, Dte.YEAR, 1, [2017, 2, 12, 14], 1489348800000, 360);

        // NOTE: DST Ends on Nov 6th at 02:00 in 2016

        // STD to DST
        _addAndExpect([2016, 10, 6, 14], 1478466000000, 420, Dte.YEAR, -6, [2010, 10, 6, 14], 1289073600000, 360);

        // NOTE: DST Starts on March 12th at 02:00 in 2017

        // DST to STD
        _addAndExpect([2017, 2, 12, 14], 1489348800000, 360, Dte.YEAR, -1, [2016, 2, 12, 14], 1457816400000, 420);
      }
      else if (guessedTz.name == 'America/Chicago') {
        // NOTE: DST Starts on March 9th at 02:00 in 2014

        // STD to DST
        _addAndExpect([2014, 2, 8, 14], 1394308800000, 360, Dte.YEAR, 1, [2015, 2, 8, 14], 1425841200000, 300);

        // DST to STD
        _addAndExpect([2014, 2, 12, 14], 1394650800000, 300, Dte.YEAR, 2, [2016, 2, 12, 14], 1457812800000, 360);

        // NOTE: DST Ends on Nov 2nd at 02:00 in 2014

        // DST to STD
        _addAndExpect([2014, 10, 1, 14], 1414868400000, 300, Dte.YEAR, 1, [2015, 10, 1, 14], 1446408000000, 360);

        // STD to DST
        _addAndExpect([2014, 10, 2, 14], 1414958400000, 360, Dte.YEAR, -3, [2011, 10, 2, 14], 1320260400000, 300);

        // NOTE: DST Starts on March 8th at 02:00 in 2015

        // DST to STD
        _addAndExpect([2015, 2, 8, 14], 1425841200000, 300, Dte.YEAR, -1, [2014, 2, 8, 14], 1394308800000, 360);

        // NOTE: DST Ends on Nov 1st at 02:00 in 2015

        // STD to DST
        _addAndExpect([2015, 10, 1, 14], 1446408000000, 360, Dte.YEAR, -1, [2014, 10, 1, 14], 1414868400000, 300);

        // NOTE: DST Starts on March 13th at 02:00 in 2016

        // STD to DST
        _addAndExpect([2016, 2, 12, 14], 1457812800000, 360, Dte.YEAR, 1, [2017, 2, 12, 14], 1489345200000, 300);

        // NOTE: DST Ends on Nov 6th at 02:00 in 2016

        // STD to DST
        _addAndExpect([2016, 10, 6, 14], 1478462400000, 360, Dte.YEAR, -6, [2010, 10, 6, 14], 1289070000000, 300);

        // NOTE: DST Starts on March 12th at 02:00 in 2017

        // DST to STD
        _addAndExpect([2017, 2, 12, 14], 1489345200000, 300, Dte.YEAR, -1, [2016, 2, 12, 14], 1457812800000, 360);
      }
      else {
        expect(true).toBe(false);
      }
  ...
  describe('.convert', function () {
    ...
    it('called with a complete date-like array literal input should return the date', function () {
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, -420], {});
      expect(date).toBeDefined();
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, '-07:00'], {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, '-0700'], {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, '-07'], {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, 0], {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, 'Z'], {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, '+00:00'], {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, '+0000'], {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert([2016, 7, 1, 12, 34, 56, 789, '+00'], {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
    ...
    it('called with a complete date-like object literal input should return the date', function () {
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: -420 }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: '-07:00' }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(12);
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: '-0700' }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(12);
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: '-07' }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(12);
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: 0 }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(12);
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: 'Z' }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(12);
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: '+00:00' }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(12);
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: '+0000' }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(12);
      ...
      date = Dte.convert({ year: 2016, month: 7, day: 12, hours: 12, minutes: 34, seconds: 56, milliseconds: 789, tzo: '+00' }, {});
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(12);
    ...
    it('called with string input and `"c"` format should return expected date', function () {
      var date;
      ...
      date = Dte.convert('2016-07-14T12:34:56.789-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14TZ', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07T12:34:56.789-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07TZ', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(0);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(0);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(0);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016T12-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(0);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016T-08:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T-0800', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T-08', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016TZ', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T+00:00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T+0000', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T+00', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(0);
      expect(date.getDate()).toBe(1);
      ...
      // Fractional Seconds of Varying Length:

      date = Dte.convert('2016-07-14T12:34:56.0Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.7Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.70Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.78Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.780Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.7890Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.7895Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.78901Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789012Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      // Variations: 1) with space in place of "T" delimiter 2) with comma in place of decimal point:

      date = Dte.convert('2016-07-14 12:34:56.789Z', { formats: 'c' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
    ...
    it('called with string input and `"U"` format should return expected date', function () {
      ...
      date = Dte.convert('notanumber', { formats: 'U' });
      expect(date).toBeNull();
    });

    it('called with string input and `"O"` format should return expected date', function () {
      var date;

      date = Dte.convert('2016-07-01T12:34:56.789-0800', { formats: 'Y-m-d\\Th:i:s.uO' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07-01T12:34:56.789-08', { formats: 'Y-m-d\\Th:i:s.uO' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07-01T12:34:56.789+0000', { formats: 'Y-m-d\\Th:i:s.uO' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07-01T12:34:56.789+00', { formats: 'Y-m-d\\Th:i:s.uO' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07-01T12:34:56.789Z', { formats: 'Y-m-d\\Th:i:s.uO' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
    ...
    it('called with string input and `"P"` format should return expected date', function () {
      var date;

      date = Dte.convert('2016-07-01T12:34:56.789-08:00', { formats: 'Y-m-d\\Th:i:s.uP' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07-01T12:34:56.789-08', { formats: 'Y-m-d\\Th:i:s.uP' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07-01T12:34:56.789+00:00', { formats: 'Y-m-d\\Th:i:s.uP' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07-01T12:34:56.789+00', { formats: 'Y-m-d\\Th:i:s.uP' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07-01T12:34:56.789Z', { formats: 'Y-m-d\\Th:i:s.uP' });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
    ...
    it('called with common ISO 8601 formatted string input should return expected date', function () {
      var date;
      ...
      date = Dte.convert('2016-07-14T12:34:56.789-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56.789');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56Z');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34:56');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34Z');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12:34');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12Z');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T12');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14T+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
      ...
      date = Dte.convert('2016-07T12:34:56.789-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789Z');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56.789');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56Z');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34:56');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34Z');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12:34');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T12+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016-07T+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789Z');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56.789');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(0);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56Z');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34:56');
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(0);
      expect(date.getDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34-0800');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34-08');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34+0000');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12:34+00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12-08:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
      ...
      date = Dte.convert('2016T12+00:00');
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(0);
      expect(date.getUTCDate()).toBe(1);
    ...
    it('called with common ISO 8601 formatted string input and various formats should return expected date', function () {
      var date;
      ...
      date = Dte.convert('2016-07-14T12:34:56', { formats: ['Y-m-d', 'now'] });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14 12:34:56', { formats: ['Y-m-d', 'now'] });
      expect(date).toBeDefined();
      expect(date.getFullYear()).toBe(2016);
      expect(date.getMonth()).toBe(6);
      expect(date.getDate()).toBe(14);
      ...
      date = Dte.convert('2016-07-14 Z', { formats: ['Y-m-d', 'now'] });
      expect(date).toBeDefined();
      expect(date.getUTCFullYear()).toBe(2016);
      expect(date.getUTCMonth()).toBe(6);
      expect(date.getUTCDate()).toBe(14);
  ...
  describe('.diff', function () {
    ...
    it('should calculate the difference of minutes between 2 dates', function () {
      ...
      if (guessedTz.name == 'America/Los_Angeles') {
        ...
        _diffAndExpect(date1, date2, Dte.MINUTES, 60 * 24 * 366);
        ...
        _diffAndExpect(date1, date2, Dte.MINUTES, 840 + -60);
        ...
        _diffAndExpect(date1, date2, Dte.MINUTES, 1);
      }
      else if (guessedTz.name == 'America/Denver') {
    ...
    it('should calculate the difference of hours between two dates', function () {
      ...
      if (guessedTz.name == 'America/Los_Angeles') {
        ...
        _diffAndExpect(date1, date2, Dte.HOURS, 24 * 366);

        date1 = createDateFromArray([2000, 5, 1, 12, 0, 1], 959886001000, 420); // During daylight savings.
        date2 = createDateFromArray([2000, 11, 1, 12, 0, 1], 975700801000, 480); // After daylight savings.
        _diffAndExpect(date1, date2, Dte.HOURS, (24 * 183) + 1);

        date1 = createDateFromArray([2000, 5, 1, 12, 0, 1], 959886001000, 420); // During daylight savings.
        date2 = createDateFromArray([2000, 6, 1, 12, 0, 1], 962478001000, 420); // During daylight savings.
        _diffAndExpect(date1, date2, Dte.HOURS, 24 * 30);

        date1 = createDateFromArray([2000, 1, 1, 12, 0, 1], 949435201000, 480); // Before daylight savings.
        date2 = createDateFromArray([2000, 6, 1, 12, 0, 1], 962478001000, 420); // During daylight savings.
        _diffAndExpect(date1, date2, Dte.HOURS, (24 * 151) + -1);
        ...
        _diffAndExpect(date1, date2, Dte.HOURS, 14 + -1);
        ...
        _diffAndExpect(date1, date2, Dte.HOURS, 9 + -1);
        ...
        _diffAndExpect(date1, date2, Dte.HOURS, 8 + 1);
      }
      else if (guessedTz.name == 'America/Chicago') {
